...
impl Default for ShortcutsConfig {
    fn default() -> Self {
        Self {
            ...
            split_pane_horizontal: "Ctrl+Shift+Backslash".into(),
            split_pane_vertical: "Ctrl+Shift+Minus".into(),
            close_pane: "Ctrl+Shift+Delete".into(),
            focus_pane_left: "Ctrl+Alt+Left".into(),
            focus_pane_right: "Ctrl+Alt+Right".into(),
            focus_pane_up: "Ctrl+Alt+Up".into(),
            focus_pane_down: "Ctrl+Alt+Down".into(),
            resize_pane_left: "Ctrl+Alt+Shift+Left".into(),
            resize_pane_right: "Ctrl+Alt+Shift+Right".into(),
            resize_pane_up: "Ctrl+Alt+Shift+Up".into(),
            resize_pane_down: "Ctrl+Alt+Shift+Down".into(),
            toggle_pane_zoom: "Ctrl+Shift+Enter".into(),
            ...
            prompt_previous: "Ctrl+Shift+Z".into(),
            prompt_next: "Ctrl+Shift+X".into(),
