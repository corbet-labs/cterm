...
use cterm_core::term::{Key, Modifiers, NamedKey, Terminal, TerminalEvent};
...
fn associated_text_for_gdk_key(key: Key, keyval: gdk::Key, modifiers: Modifiers) -> Option<String> {
...
mod tests {
    ...
    #[test]
    fn kitty_named_keys_cover_wayland_modifiers_media_and_extended_functions() {
        assert_eq!(
    ...
    #[test]
    fn kitty_pc101_identity_uses_physical_wayland_keycodes() {
    ...
    #[test]
    fn kitty_all_key_mode_routes_plain_and_modifier_keys() {
        let mut terminal = Terminal::new(8, 2, ScreenConfig::default());
