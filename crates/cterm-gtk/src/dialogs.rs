    ...
    fn collect_config(&self, base_config: &Config) -> Config {
        ...
        for (name, entry) in &self.shortcut_entries {
            ...
            match name.as_str() {
                ...
                "split_pane_horizontal" => config.shortcuts.split_pane_horizontal = value,
                "split_pane_vertical" => config.shortcuts.split_pane_vertical = value,
                "close_pane" => config.shortcuts.close_pane = value,
                "focus_pane_left" => config.shortcuts.focus_pane_left = value,
                "focus_pane_right" => config.shortcuts.focus_pane_right = value,
                "focus_pane_up" => config.shortcuts.focus_pane_up = value,
                "focus_pane_down" => config.shortcuts.focus_pane_down = value,
                "resize_pane_left" => config.shortcuts.resize_pane_left = value,
                "resize_pane_right" => config.shortcuts.resize_pane_right = value,
                "resize_pane_up" => config.shortcuts.resize_pane_up = value,
                "resize_pane_down" => config.shortcuts.resize_pane_down = value,
                "toggle_pane_zoom" => config.shortcuts.toggle_pane_zoom = value,
...
fn create_shortcuts_preferences(config: &Config) -> (GtkBox, Vec<(String, Entry)>) {
    ...
    let shortcuts = [
        ...
        (
            ...
            &config.shortcuts.split_pane_horizontal,
        ),
        (
            "split_pane_vertical",
            "Split Pane Vertically",
            &config.shortcuts.split_pane_vertical,
        ),
        ("close_pane", "Close Pane", &config.shortcuts.close_pane),
        (
            "focus_pane_left",
            "Focus Pane Left",
            &config.shortcuts.focus_pane_left,
        ),
        (
            "focus_pane_right",
            "Focus Pane Right",
            &config.shortcuts.focus_pane_right,
        ),
        (
            "focus_pane_up",
            "Focus Pane Up",
            &config.shortcuts.focus_pane_up,
        ),
        (
            "focus_pane_down",
            "Focus Pane Down",
            &config.shortcuts.focus_pane_down,
        ),
        (
            "resize_pane_left",
            "Resize Pane Left",
            &config.shortcuts.resize_pane_left,
        ),
        (
            "resize_pane_right",
            "Resize Pane Right",
            &config.shortcuts.resize_pane_right,
        ),
        (
            "resize_pane_up",
            "Resize Pane Up",
            &config.shortcuts.resize_pane_up,
        ),
        (
            "resize_pane_down",
            "Resize Pane Down",
            &config.shortcuts.resize_pane_down,
        ),
        (
            "toggle_pane_zoom",
            "Toggle Pane Zoom",
            &config.shortcuts.toggle_pane_zoom,
        ),
